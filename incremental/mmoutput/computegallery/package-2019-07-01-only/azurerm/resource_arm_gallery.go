...
func resourceArmGallery() *schema.Resource {
    return &schema.Resource{
        Create: resourceArmGalleryCreate,
        Read: resourceArmGalleryRead,
        Update: resourceArmGalleryUpdate,
...
func resourceArmGalleryCreate(d *schema.ResourceData, meta interface{}) error {
...
func resourceArmGalleryUpdate(d *schema.ResourceData, meta interface{}) error {
    client := meta.(*ArmClient).galleriesClient
    ctx := meta.(*ArmClient).StopContext
    ...
    future, err := client.Update(ctx, resourceGroup, name, gallery)
    if err != nil {
        return fmt.Errorf("Error updating Gallery %q (Resource Group %q): %+v", name, resourceGroup, err)
    }
    if err = future.WaitForCompletionRef(ctx, client.Client); err != nil {
        return fmt.Errorf("Error waiting for update of Gallery %q (Resource Group %q): %+v", name, resourceGroup, err)
    }
