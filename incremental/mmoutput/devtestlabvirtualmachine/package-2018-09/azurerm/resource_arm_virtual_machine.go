...
func resourceArmVirtualMachineCreate(d *schema.ResourceData, meta interface{}) error {
    ...
    labVirtualMachine := devtestlab.LabVirtualMachine{
        ...
        LabVirtualMachineProperties: &devtestlab.LabVirtualMachineProperties{
            ...
            DataDiskParameters: expandArmVirtualMachineDataDiskProperties(dataDiskParameters),
            ...
            ScheduleParameters: expandArmVirtualMachineScheduleCreationParameter(scheduleParameters),
...
func resourceArmVirtualMachineRead(d *schema.ResourceData, meta interface{}) error {
    ...
    if labVirtualMachineProperties := resp.LabVirtualMachineProperties; labVirtualMachineProperties != nil {
        ...
        if err := d.Set("data_disk_parameters", flattenArmVirtualMachineDataDiskProperties(labVirtualMachineProperties.DataDiskParameters)); err != nil {
        ...
        d.Set("last_known_power_state", labVirtualMachineProperties.LastKnownPowerState)
        ...
        d.Set("plan_id", labVirtualMachineProperties.PlanID)
        d.Set("provisioning_state", labVirtualMachineProperties.ProvisioningState)
        if err := d.Set("schedule_parameters", flattenArmVirtualMachineScheduleCreationParameter(labVirtualMachineProperties.ScheduleParameters)); err != nil {
...
func expandArmVirtualMachineDataDiskProperties(input []interface{}) *[]devtestlab.DataDiskProperties {
...
func expandArmVirtualMachineScheduleCreationParameter(input []interface{}) *[]devtestlab.ScheduleCreationParameter {
...
func flattenArmVirtualMachineDataDiskProperties(input *[]devtestlab.DataDiskProperties) []interface{} {
    results := make([]interface{}, 0)
    if input == nil {
        return results
    }
    ...
    for _, item := range *input {
        ...
        v["attach_new_data_disk_options"] = flattenArmVirtualMachineAttachNewDataDiskOptions(item.AttachNewDataDiskOptions)
...
func flattenArmVirtualMachineScheduleCreationParameter(input *[]devtestlab.ScheduleCreationParameter) []interface{} {
    results := make([]interface{}, 0)
    if input == nil {
        return results
    }
    ...
    for _, item := range *input {
        ...
        if scheduleCreationParameterProperties := item.ScheduleCreationParameterProperties; scheduleCreationParameterProperties != nil {
            v["daily_recurrence"] = flattenArmVirtualMachineDayDetails(scheduleCreationParameterProperties.DailyRecurrence)
            v["hourly_recurrence"] = flattenArmVirtualMachineHourDetails(scheduleCreationParameterProperties.HourlyRecurrence)
            v["notification_settings"] = flattenArmVirtualMachineNotificationSettings(scheduleCreationParameterProperties.NotificationSettings)
            ...
            v["weekly_recurrence"] = flattenArmVirtualMachineWeekDetails(scheduleCreationParameterProperties.WeeklyRecurrence)
        }
...
func flattenArmVirtualMachineAttachNewDataDiskOptions(input *devtestlab.AttachNewDataDiskOptions) []interface{} {
    if input == nil {
        return make([]interface{}, 0)
    }
