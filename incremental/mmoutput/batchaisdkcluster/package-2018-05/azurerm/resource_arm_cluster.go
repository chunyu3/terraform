...
func resourceArmClusterCreate(d *schema.ResourceData, meta interface{}) error {
    ...
    if features.ShouldResourcesBeImported() && d.IsNewResource() {
        ...
        if err != nil {
            if !utils.ResponseWasNotFound(existing.Response) {
                return fmt.Errorf("Error checking for present of existing Cluster %q (Workspace Name %q / Resource Group %q): %+v", name, workspaceName, resourceGroup, err)
            }
        }
    ...
    if err != nil {
        return fmt.Errorf("Error creating Cluster %q (Workspace Name %q / Resource Group %q): %+v", name, workspaceName, resourceGroup, err)
    }
    if err = future.WaitForCompletionRef(ctx, client.Client); err != nil {
        return fmt.Errorf("Error waiting for creation of Cluster %q (Workspace Name %q / Resource Group %q): %+v", name, workspaceName, resourceGroup, err)
    }


    resp, err := client.Get(ctx, resourceGroup, workspaceName, name)
    if err != nil {
        return fmt.Errorf("Error retrieving Cluster %q (Workspace Name %q / Resource Group %q): %+v", name, workspaceName, resourceGroup, err)
    }
    if resp.ID == nil {
        return fmt.Errorf("Cannot read Cluster %q (Workspace Name %q / Resource Group %q) ID", name, workspaceName, resourceGroup)
    }
    d.SetId(*resp.ID)
...
func resourceArmClusterRead(d *schema.ResourceData, meta interface{}) error {
    ...
    if err != nil {
        ...
        return fmt.Errorf("Error reading Cluster %q (Workspace Name %q / Resource Group %q): %+v", name, workspaceName, resourceGroup, err)
    }
...
func resourceArmClusterUpdate(d *schema.ResourceData, meta interface{}) error {
    ...
    if _, err := client.Update(ctx, resourceGroup, workspaceName, name, parameters); err != nil {
        return fmt.Errorf("Error updating Cluster %q (Workspace Name %q / Resource Group %q): %+v", name, workspaceName, resourceGroup, err)
    }
...
func resourceArmClusterDelete(d *schema.ResourceData, meta interface{}) error {
    ...
    if err != nil {
        ...
        return fmt.Errorf("Error deleting Cluster %q (Workspace Name %q / Resource Group %q): %+v", name, workspaceName, resourceGroup, err)
    }

    if err = future.WaitForCompletionRef(ctx, client.Client); err != nil {
        if !response.WasNotFound(future.Response()) {
            return fmt.Errorf("Error waiting for deleting Cluster %q (Workspace Name %q / Resource Group %q): %+v", name, workspaceName, resourceGroup, err)
        }
    }
