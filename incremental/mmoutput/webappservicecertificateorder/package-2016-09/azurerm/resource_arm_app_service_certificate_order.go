...
func resourceArmAppServiceCertificateOrderCreate(d *schema.ResourceData, meta interface{}) error {
    ...
    if features.ShouldResourcesBeImported() && d.IsNewResource() {
        ...
        if err != nil {
            if !utils.ResponseWasNotFound(existing.Response) {
                return fmt.Errorf("Error checking for present of existing App Service Certificate Order %q (Resource Group %q): %+v", name, resourceGroup, err)
            }
        }
    ...
    future, err := client.CreateOrUpdate(ctx, resourceGroup, name, certificateDistinguishedName)
    if err != nil {
        return fmt.Errorf("Error creating App Service Certificate Order %q (Resource Group %q): %+v", name, resourceGroup, err)
    }
    if err = future.WaitForCompletionRef(ctx, client.Client); err != nil {
        return fmt.Errorf("Error waiting for creation of App Service Certificate Order %q (Resource Group %q): %+v", name, resourceGroup, err)
    }


    resp, err := client.Get(ctx, resourceGroup, name)
    if err != nil {
        return fmt.Errorf("Error retrieving App Service Certificate Order %q (Resource Group %q): %+v", name, resourceGroup, err)
    }
    if resp.ID == nil {
...
func resourceArmAppServiceCertificateOrderRead(d *schema.ResourceData, meta interface{}) error {
    ...
    if err != nil {
        ...
        return fmt.Errorf("Error reading App Service Certificate Order %q (Resource Group %q): %+v", name, resourceGroup, err)
    }
...
func resourceArmAppServiceCertificateOrderUpdate(d *schema.ResourceData, meta interface{}) error {
    ...
    if _, err := client.Update(ctx, resourceGroup, name, certificateDistinguishedName); err != nil {
        return fmt.Errorf("Error updating App Service Certificate Order %q (Resource Group %q): %+v", name, resourceGroup, err)
    }
...
func resourceArmAppServiceCertificateOrderDelete(d *schema.ResourceData, meta interface{}) error {
    ...
    if _, err := client.Delete(ctx, resourceGroup, name); err != nil {
        return fmt.Errorf("Error deleting App Service Certificate Order %q (Resource Group %q): %+v", name, resourceGroup, err)
    }
