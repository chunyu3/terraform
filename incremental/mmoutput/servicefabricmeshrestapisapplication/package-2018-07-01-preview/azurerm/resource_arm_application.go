...
func flattenArmApplicationContainerCodePackageProperties(input *[]servicefabricmeshrestapis.ContainerCodePackageProperties) []interface{} {
    ...
    for _, item := range *input {
        ...
        v["volume_refs"] = flattenArmApplicationContainerVolume(item.VolumeRefs)
...
func flattenArmApplicationContainerVolume(input *[]servicefabricmeshrestapis.ContainerVolume) []interface{} {
    results := make([]interface{}, 0)
    if input == nil {
        return results
    }
