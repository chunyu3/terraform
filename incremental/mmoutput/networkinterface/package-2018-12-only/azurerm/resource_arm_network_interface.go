...
func resourceArmNetworkInterfaceCreateUpdate(d *schema.ResourceData, meta interface{}) error {
    ...
    tapConfigurations := d.Get("tap_configurations").([]interface{})
    ...
    parameters := network.Interface{
        ...
        InterfacePropertiesFormat: &network.InterfacePropertiesFormat{
            ...
            TapConfigurations: expandArmNetworkInterfaceInterfaceTapConfiguration(tapConfigurations),
        },
        Tags: tags.Expand(t),
    }
...
func resourceArmNetworkInterfaceRead(d *schema.ResourceData, meta interface{}) error {
    ...
    if interfacePropertiesFormat := resp.InterfacePropertiesFormat; interfacePropertiesFormat != nil {
        ...
        d.Set("hosted_workloads", utils.FlattenStringSlice(interfacePropertiesFormat.HostedWorkloads))
        if err := d.Set("interface_endpoint", flattenArmNetworkInterfaceInterfaceEndpoint(interfacePropertiesFormat.InterfaceEndpoint)); err != nil {
            return fmt.Errorf("Error setting `interface_endpoint`: %+v", err)
        }
        ...
        if err := d.Set("tap_configurations", flattenArmNetworkInterfaceInterfaceTapConfiguration(interfacePropertiesFormat.TapConfigurations)); err != nil {
            return fmt.Errorf("Error setting `tap_configurations`: %+v", err)
        }
    ...
    for _, item := range input {
        ...
        result := network.InterfaceIPConfiguration{
            ...
            InterfaceIPConfigurationPropertiesFormat: &network.InterfaceIPConfigurationPropertiesFormat{
                ...
                ApplicationSecurityGroups: expandArmNetworkInterfaceApplicationSecurityGroup(applicationSecurityGroups),
                ...
                VirtualNetworkTaps: expandArmNetworkInterfaceVirtualNetworkTap(virtualNetworkTaps),
            },
        }
...
func expandArmNetworkInterfaceInterfaceTapConfiguration(input []interface{}) *[]network.InterfaceTapConfiguration {
    results := make([]network.InterfaceTapConfiguration, 0)
    for _, item := range input {
        v := item.(map[string]interface{})
        id := v["id"].(string)
        virtualNetworkTap := v["virtual_network_tap"].([]interface{})
        name := v["name"].(string)
        etag := v["etag"].(string)

        result := network.InterfaceTapConfiguration{
            Etag: utils.String(etag),
            ID: utils.String(id),
            Name: utils.String(name),
            InterfaceTapConfigurationPropertiesFormat: &network.InterfaceTapConfigurationPropertiesFormat{
                VirtualNetworkTap: expandArmNetworkInterfaceVirtualNetworkTap(virtualNetworkTap),
            },
        }
...
func expandArmNetworkInterfaceApplicationSecurityGroup(input []interface{}) *[]network.ApplicationSecurityGroup {
...
func expandArmNetworkInterfaceVirtualNetworkTap(input []interface{}) *[]network.VirtualNetworkTap {
...
func flattenArmNetworkInterfaceInterfaceEndpoint(input *network.InterfaceEndpoint) []interface{} {
    if input == nil {
        return make([]interface{}, 0)
    }
...
func flattenArmNetworkInterfaceInterfaceIPConfiguration(input *[]network.InterfaceIPConfiguration) []interface{} {
    ...
    for _, item := range *input {
        ...
        if interfaceIPConfigurationPropertiesFormat := item.InterfaceIPConfigurationPropertiesFormat; interfaceIPConfigurationPropertiesFormat != nil {
            ...
            v["application_security_groups"] = flattenArmNetworkInterfaceApplicationSecurityGroup(interfaceIPConfigurationPropertiesFormat.ApplicationSecurityGroups)
            ...
            v["virtual_network_taps"] = flattenArmNetworkInterfaceVirtualNetworkTap(interfaceIPConfigurationPropertiesFormat.VirtualNetworkTaps)
        }
...
func flattenArmNetworkInterfaceInterfaceTapConfiguration(input *[]network.InterfaceTapConfiguration) []interface{} {
    results := make([]interface{}, 0)
    if input == nil {
        return results
    }
    ...
    for _, item := range *input {
        ...
        if interfaceTapConfigurationPropertiesFormat := item.InterfaceTapConfigurationPropertiesFormat; interfaceTapConfigurationPropertiesFormat != nil {
            v["virtual_network_tap"] = flattenArmNetworkInterfaceVirtualNetworkTap(interfaceTapConfigurationPropertiesFormat.VirtualNetworkTap)
        }
...
func flattenArmNetworkInterfaceApplicationSecurityGroup(input *[]network.ApplicationSecurityGroup) []interface{} {
    results := make([]interface{}, 0)
    if input == nil {
        return results
    }
...
func flattenArmNetworkInterfaceVirtualNetworkTap(input *[]network.VirtualNetworkTap) []interface{} {
    results := make([]interface{}, 0)
    if input == nil {
        return results
    }
