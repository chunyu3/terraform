...
func resourceArmRouteTableCreateUpdate(d *schema.ResourceData, meta interface{}) error {
    ...
    parameters := network.RouteTable{
        ...
        RouteTablePropertiesFormat: &network.RouteTablePropertiesFormat{
            ...
            Subnets: expandArmRouteTableSubnet(subnets),
        },
        Tags: tags.Expand(t),
    }
...
func expandArmRouteTableSubnet(input []interface{}) *[]network.Subnet {
    ...
    for _, item := range input {
        ...
        result := network.Subnet{
            ...
            SubnetPropertiesFormat: &network.SubnetPropertiesFormat{
                AddressPrefix: utils.String(addressPrefix),
                IpConfigurations: expandArmRouteTableIPConfiguration(ipConfigurations),
                NetworkSecurityGroup: expandArmRouteTableSecurityGroup(networkSecurityGroup),
                RouteTable: expandArmRouteTableRouteTable(routeTable),
            },
        }
...
func expandArmRouteTableIPConfiguration(input []interface{}) *[]network.IPConfiguration {
...
func expandArmRouteTableSecurityGroup(input []interface{}) *network.SecurityGroup {
    if len(input) == 0 {
        return nil
    }
...
func expandArmRouteTableRouteTable(input []interface{}) *network.RouteTable {
    if len(input) == 0 {
        return nil
    }
    v := input[0].(map[string]interface{})
...
func flattenArmRouteTableSubnet(input *[]network.Subnet) []interface{} {
    ...
    for _, item := range *input {
        ...
        if subnetPropertiesFormat := item.SubnetPropertiesFormat; subnetPropertiesFormat != nil {
            ...
            v["ip_configurations"] = flattenArmRouteTableIPConfiguration(subnetPropertiesFormat.IpConfigurations)
            v["network_security_group"] = flattenArmRouteTableSecurityGroup(subnetPropertiesFormat.NetworkSecurityGroup)
            v["route_table"] = flattenArmRouteTableRouteTable(subnetPropertiesFormat.RouteTable)
        }
        if etag := item.Etag; etag != nil {
            v["etag"] = *etag
        }
...
func flattenArmRouteTableIPConfiguration(input *[]network.IPConfiguration) []interface{} {
    results := make([]interface{}, 0)
    if input == nil {
        return results
    }
...
func flattenArmRouteTableSecurityGroup(input *network.SecurityGroup) []interface{} {
    if input == nil {
...
func flattenArmRouteTableRouteTable(input *network.RouteTable) []interface{} {
    if input == nil {
        return make([]interface{}, 0)
    }
