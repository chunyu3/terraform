...
func resourceArmSnapshotCreate(d *schema.ResourceData, meta interface{}) error {
    ...
    snapshot := compute.Snapshot{
        ...
        SnapshotProperties: &compute.SnapshotProperties{
            ...
            Encryption: expandArmSnapshotEncryption(encryption),
...
func resourceArmSnapshotRead(d *schema.ResourceData, meta interface{}) error {
    ...
    if snapshotProperties := resp.SnapshotProperties; snapshotProperties != nil {
        ...
        if err := d.Set("encryption", flattenArmSnapshotEncryption(snapshotProperties.Encryption)); err != nil {
...
func expandArmSnapshotEncryption(input []interface{}) *compute.Encryption {
    if len(input) == 0 {
        return nil
    }
    v := input[0].(map[string]interface{})
