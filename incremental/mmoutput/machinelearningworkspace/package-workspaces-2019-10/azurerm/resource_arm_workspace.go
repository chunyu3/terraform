...
func expandArmWorkspaceSku(input []interface{}) *machinelearning.Sku {
    if len(input) == 0 {
        return nil
    }
...
func flattenArmWorkspaceSku(input *machinelearning.Sku) []interface{} {
    if input == nil {
