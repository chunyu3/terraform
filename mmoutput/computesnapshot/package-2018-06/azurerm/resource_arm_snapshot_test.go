...
func testCheckAzureRMSnapshotExists(resourceName string) resource.TestCheckFunc {
    return func(s *terraform.State) error {
        ...
        if resp, err := client.Get(ctx, resourceGroup, snapshotName); err != nil {
            if utils.ResponseWasNotFound(resp.Response) {
                return fmt.Errorf("Bad: Snapshot (Snapshot Name %q / Resource Group %q) does not exist", snapshotName, resourceGroup)
            }
