...
func resourceArmManagedClusterCreateUpdate(d *schema.ResourceData, meta interface{}) error {
    ...
    apiServerAccessProfile := d.Get("api_server_access_profile").([]interface{})
    ...
    parameters := containerservices.ManagedCluster{
        ...
        ManagedClusterProperties: &containerservices.ManagedClusterProperties{
            ...
            ApiServerAccessProfile: expandArmManagedClusterManagedClusterAPIServerAccessProfile(apiServerAccessProfile),
...
func resourceArmManagedClusterRead(d *schema.ResourceData, meta interface{}) error {
    ...
    if managedClusterProperties := resp.ManagedClusterProperties; managedClusterProperties != nil {
        ...
        if err := d.Set("api_server_access_profile", flattenArmManagedClusterManagedClusterAPIServerAccessProfile(managedClusterProperties.ApiServerAccessProfile)); err != nil {
        ...
        d.Set("private_fqdn", managedClusterProperties.PrivateFqdn)
...
func expandArmManagedClusterManagedClusterAgentPoolProfile(input []interface{}) *[]containerservices.ManagedClusterAgentPoolProfile {
    ...
    for _, item := range input {
        ...
        enableNodePublicIp := v["enable_node_public_ip"].(bool)
        scaleSetPriority := v["scale_set_priority"].(string)
        scaleSetEvictionPolicy := v["scale_set_eviction_policy"].(string)
        nodeTaints := v["node_taints"].([]interface{})
        name := v["name"].(string)
...
func expandArmManagedClusterManagedClusterAPIServerAccessProfile(input []interface{}) *containerservices.ManagedClusterAPIServerAccessProfile {
    if len(input) == 0 {
        return nil
    }
    v := input[0].(map[string]interface{})

    authorizedIpranges := v["authorized_ipranges"].([]interface{})
    enablePrivateCluster := v["enable_private_cluster"].(bool)

    result := containerservices.ManagedClusterAPIServerAccessProfile{
        AuthorizedIpranges: utils.ExpandStringSlice(authorizedIpranges),
        EnablePrivateCluster: utils.Bool(enablePrivateCluster),
    }
    return &result
}
...
func expandArmManagedClusterContainerServiceNetworkProfile(input []interface{}) *containerservices.ContainerServiceNetworkProfile {
    ...
    loadBalancerProfile := v["load_balancer_profile"].([]interface{})
    ...
    result := containerservices.ContainerServiceNetworkProfile{
        ...
        LoadBalancerProfile: expandArmManagedClusterManagedClusterLoadBalancerProfile(loadBalancerProfile),
...
func expandArmManagedClusterManagedClusterLoadBalancerProfile(input []interface{}) *containerservices.ManagedClusterLoadBalancerProfile {
    if len(input) == 0 {
        return nil
    }
    v := input[0].(map[string]interface{})

    managedOutboundIps := v["managed_outbound_ips"].([]interface{})
    outboundIpprefixes := v["outbound_ipprefixes"].([]interface{})
    outboundIps := v["outbound_ips"].([]interface{})
    effectiveOutboundIps := v["effective_outbound_ips"].([]interface{})

    result := containerservices.ManagedClusterLoadBalancerProfile{
        EffectiveOutboundIps: expandArmManagedClusterResourceReference(effectiveOutboundIps),
        ManagedOutboundIps: expandArmManagedClusterManagedClusterLoadBalancerProfile_managedOutboundIPs(managedOutboundIps),
        OutboundIpprefixes: expandArmManagedClusterManagedClusterLoadBalancerProfile_outboundIPPrefixes(outboundIpprefixes),
        OutboundIps: expandArmManagedClusterManagedClusterLoadBalancerProfile_outboundIPs(outboundIps),
    }
    return &result
}
...
func expandArmManagedClusterResourceReference(input []interface{}) *[]containerservices.ResourceReference {
    results := make([]containerservices.ResourceReference, 0)
    for _, item := range input {
        v := item.(map[string]interface{})
        id := v["id"].(string)

        result := containerservices.ResourceReference{
            ID: utils.String(id),
        }
...
func expandArmManagedClusterManagedClusterLoadBalancerProfile_managedOutboundIPs(input []interface{}) *containerservices.ManagedClusterLoadBalancerProfile_managedOutboundIPs {
    if len(input) == 0 {
        return nil
    }
    v := input[0].(map[string]interface{})
    ...
    result := containerservices.ManagedClusterLoadBalancerProfile_managedOutboundIPs{
        Count: utils.Int32(int32(count)),
    }
    return &result
}

func expandArmManagedClusterManagedClusterLoadBalancerProfile_outboundIPPrefixes(input []interface{}) *containerservices.ManagedClusterLoadBalancerProfile_outboundIPPrefixes {
    if len(input) == 0 {
        return nil
    }
    v := input[0].(map[string]interface{})

    publicIpprefixes := v["public_ipprefixes"].([]interface{})

    result := containerservices.ManagedClusterLoadBalancerProfile_outboundIPPrefixes{
        PublicIpprefixes: expandArmManagedClusterResourceReference(publicIpprefixes),
    }
    return &result
}

func expandArmManagedClusterManagedClusterLoadBalancerProfile_outboundIPs(input []interface{}) *containerservices.ManagedClusterLoadBalancerProfile_outboundIPs {
    if len(input) == 0 {
        return nil
    }
    v := input[0].(map[string]interface{})

    publicIps := v["public_ips"].([]interface{})

    result := containerservices.ManagedClusterLoadBalancerProfile_outboundIPs{
        PublicIps: expandArmManagedClusterResourceReference(publicIps),
    }
    return &result
}
...
func flattenArmManagedClusterManagedClusterAgentPoolProfile(input *[]containerservices.ManagedClusterAgentPoolProfile) []interface{} {
    ...
    for _, item := range *input {
        ...
        if enableNodePublicIp := item.EnableNodePublicIp; enableNodePublicIp != nil {
            v["enable_node_public_ip"] = *enableNodePublicIp
        }
        ...
        v["node_taints"] = utils.FlattenStringSlice(item.NodeTaints)
        ...
        v["scale_set_eviction_policy"] = string(item.ScaleSetEvictionPolicy)
        v["scale_set_priority"] = string(item.ScaleSetPriority)
...
func flattenArmManagedClusterManagedClusterAPIServerAccessProfile(input *containerservices.ManagedClusterAPIServerAccessProfile) []interface{} {
    if input == nil {
        return make([]interface{}, 0)
    }
    ...
    result["authorized_ipranges"] = utils.FlattenStringSlice(input.AuthorizedIpranges)
    if enablePrivateCluster := input.EnablePrivateCluster; enablePrivateCluster != nil {
        result["enable_private_cluster"] = *enablePrivateCluster
    }
...
func flattenArmManagedClusterContainerServiceNetworkProfile(input *containerservices.ContainerServiceNetworkProfile) []interface{} {
    ...
    result["load_balancer_profile"] = flattenArmManagedClusterManagedClusterLoadBalancerProfile(input.LoadBalancerProfile)
...
func flattenArmManagedClusterManagedClusterLoadBalancerProfile(input *containerservices.ManagedClusterLoadBalancerProfile) []interface{} {
    if input == nil {
        return make([]interface{}, 0)
    }
    ...
    result["effective_outbound_ips"] = flattenArmManagedClusterResourceReference(input.EffectiveOutboundIps)
    result["managed_outbound_ips"] = flattenArmManagedClusterManagedClusterLoadBalancerProfile_managedOutboundIPs(input.ManagedOutboundIps)
    result["outbound_ipprefixes"] = flattenArmManagedClusterManagedClusterLoadBalancerProfile_outboundIPPrefixes(input.OutboundIpprefixes)
    result["outbound_ips"] = flattenArmManagedClusterManagedClusterLoadBalancerProfile_outboundIPs(input.OutboundIps)
...
func flattenArmManagedClusterResourceReference(input *[]containerservices.ResourceReference) []interface{} {
    results := make([]interface{}, 0)
    if input == nil {
        return results
    }
...
func flattenArmManagedClusterManagedClusterLoadBalancerProfile_managedOutboundIPs(input *containerservices.ManagedClusterLoadBalancerProfile_managedOutboundIPs) []interface{} {
    if input == nil {
        return make([]interface{}, 0)
    }
...
func flattenArmManagedClusterManagedClusterLoadBalancerProfile_outboundIPPrefixes(input *containerservices.ManagedClusterLoadBalancerProfile_outboundIPPrefixes) []interface{} {
    if input == nil {
        return make([]interface{}, 0)
    }
    ...
    result["public_ipprefixes"] = flattenArmManagedClusterResourceReference(input.PublicIpprefixes)

    return []interface{}{result}
}

func flattenArmManagedClusterManagedClusterLoadBalancerProfile_outboundIPs(input *containerservices.ManagedClusterLoadBalancerProfile_outboundIPs) []interface{} {
    if input == nil {
        return make([]interface{}, 0)
    }
    ...
    result["public_ips"] = flattenArmManagedClusterResourceReference(input.PublicIps)
