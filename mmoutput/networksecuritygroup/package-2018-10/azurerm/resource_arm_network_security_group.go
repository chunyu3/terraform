...
func expandArmNetworkSecurityGroupSecurityRule(input []interface{}) *[]network.SecurityRule {
    ...
    for _, item := range input {
        ...
        sourceApplicationSecurityGroups := v["source_application_security_groups"].([]interface{})
        ...
        destinationApplicationSecurityGroups := v["destination_application_security_groups"].([]interface{})
        ...
        result := network.SecurityRule{
            ...
            SecurityRulePropertiesFormat: &network.SecurityRulePropertiesFormat{
                ...
                DestinationApplicationSecurityGroups: expandArmNetworkSecurityGroupApplicationSecurityGroup(destinationApplicationSecurityGroups),
                ...
                SourceApplicationSecurityGroups: expandArmNetworkSecurityGroupApplicationSecurityGroup(sourceApplicationSecurityGroups),
...
func expandArmNetworkSecurityGroupApplicationSecurityGroup(input []interface{}) *[]network.ApplicationSecurityGroup {
...
func flattenArmNetworkSecurityGroupSecurityRule(input *[]network.SecurityRule) []interface{} {
    ...
    for _, item := range *input {
        ...
        if securityRulePropertiesFormat := item.SecurityRulePropertiesFormat; securityRulePropertiesFormat != nil {
            ...
            v["destination_application_security_groups"] = flattenArmNetworkSecurityGroupApplicationSecurityGroup(securityRulePropertiesFormat.DestinationApplicationSecurityGroups)
            ...
            v["source_application_security_groups"] = flattenArmNetworkSecurityGroupApplicationSecurityGroup(securityRulePropertiesFormat.SourceApplicationSecurityGroups)
...
func flattenArmNetworkSecurityGroupApplicationSecurityGroup(input *[]network.ApplicationSecurityGroup) []interface{} {
    results := make([]interface{}, 0)
    if input == nil {
        return results
    }
