...
func resourceArmVirtualNetworkCreateUpdate(d *schema.ResourceData, meta interface{}) error {
    ...
    ddosProtectionPlan := d.Get("ddos_protection_plan").([]interface{})
    ...
    parameters := network.VirtualNetwork{
        ...
        VirtualNetworkPropertiesFormat: &network.VirtualNetworkPropertiesFormat{
            ...
            DdosProtectionPlan: expandArmVirtualNetworkSubResource(ddosProtectionPlan),
...
func resourceArmVirtualNetworkRead(d *schema.ResourceData, meta interface{}) error {
    ...
    if virtualNetworkPropertiesFormat := resp.VirtualNetworkPropertiesFormat; virtualNetworkPropertiesFormat != nil {
        ...
        if err := d.Set("ddos_protection_plan", flattenArmVirtualNetworkSubResource(virtualNetworkPropertiesFormat.DdosProtectionPlan)); err != nil {
    ...
    for _, item := range input {
        ...
        result := network.Subnet{
            ...
            SubnetPropertiesFormat: &network.SubnetPropertiesFormat{
                ...
                AddressPrefixes: utils.ExpandStringSlice(addressPrefixes),
                Delegations: expandArmVirtualNetworkDelegation(delegations),
                ...
                ServiceAssociationLinks: expandArmVirtualNetworkServiceAssociationLink(serviceAssociationLinks),
                ServiceEndpointPolicies: expandArmVirtualNetworkServiceEndpointPolicy(serviceEndpointPolicies),
...
func expandArmVirtualNetworkDelegation(input []interface{}) *[]network.Delegation {
...
func expandArmVirtualNetworkServiceAssociationLink(input []interface{}) *[]network.ServiceAssociationLink {
...
func expandArmVirtualNetworkServiceEndpointPolicy(input []interface{}) *[]network.ServiceEndpointPolicy {
...
func flattenArmVirtualNetworkSubnet(input *[]network.Subnet) []interface{} {
    ...
    for _, item := range *input {
        ...
        if subnetPropertiesFormat := item.SubnetPropertiesFormat; subnetPropertiesFormat != nil {
            ...
            v["address_prefixes"] = utils.FlattenStringSlice(subnetPropertiesFormat.AddressPrefixes)
            v["delegations"] = flattenArmVirtualNetworkDelegation(subnetPropertiesFormat.Delegations)
            ...
            v["service_association_links"] = flattenArmVirtualNetworkServiceAssociationLink(subnetPropertiesFormat.ServiceAssociationLinks)
            v["service_endpoint_policies"] = flattenArmVirtualNetworkServiceEndpointPolicy(subnetPropertiesFormat.ServiceEndpointPolicies)
...
func flattenArmVirtualNetworkDelegation(input *[]network.Delegation) []interface{} {
    results := make([]interface{}, 0)
    if input == nil {
        return results
    }
...
func flattenArmVirtualNetworkServiceAssociationLink(input *[]network.ServiceAssociationLink) []interface{} {
    results := make([]interface{}, 0)
    if input == nil {
        return results
    }
...
func flattenArmVirtualNetworkServiceEndpointPolicy(input *[]network.ServiceEndpointPolicy) []interface{} {
    results := make([]interface{}, 0)
    if input == nil {
        return results
    }
