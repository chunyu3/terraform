...
func testCheckAzureRMTopicExists(resourceName string) resource.TestCheckFunc {
    return func(s *terraform.State) error {
        ...
        if resp, err := client.Get(ctx, resourceGroup, namespaceName, topicName); err != nil {
            if utils.ResponseWasNotFound(resp.Response) {
                return fmt.Errorf("Bad: Topic (Topic Name %q / Namespace Name %q / Resource Group %q) does not exist", topicName, namespaceName, resourceGroup)
            }
