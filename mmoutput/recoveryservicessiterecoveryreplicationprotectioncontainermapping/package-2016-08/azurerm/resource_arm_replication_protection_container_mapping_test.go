...
func testCheckAzureRMReplicationProtectionContainerMappingExists(resourceName string) resource.TestCheckFunc {
    return func(s *terraform.State) error {
        ...
        if resp, err := client.Get(ctx, resourceName, resourceGroup, fabricName, protectionContainerName, mappingName); err != nil {
            if utils.ResponseWasNotFound(resp.Response) {
                return fmt.Errorf("Bad: Replication Protection Container Mapping (Mapping Name %q / Protection Container Name %q / Fabric Name %q / Resource Group %q / Resource Name %q) does not exist", mappingName, protectionContainerName, fabricName, resourceGroup, resourceName)
            }
