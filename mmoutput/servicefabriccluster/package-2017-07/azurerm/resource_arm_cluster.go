        ...
        Schema: map[string]*schema.Schema{
            ...
            "add_on_features": {
                ...
                Elem: &schema.Schema{
                    Type: schema.TypeString,
                    ValidateFunc: validation.StringInSlice([]string{
                        string(servicefabric.RepairManager),
                        string(servicefabric.DnsService),
                        string(servicefabric.BackupRestoreService),
                   }, false),
                },
            },
                ...
                Elem: &schema.Resource{
                    Schema: map[string]*schema.Schema{
                        ...
                        "environment": {
                            ...
                            Optional: true,
                            ValidateFunc: validation.StringInSlice([]string{
                                string(servicefabric.Windows),
                                string(servicefabric.Linux),
                            }, false),
                            Default: string(servicefabric.Windows),
                        },
                        "support_expiry_utc": {
                            Type: schema.TypeString,
                            Optional: true,
            ...
            "cluster_state": {
                ...
                Optional: true,
                ValidateFunc: validation.StringInSlice([]string{
                    string(servicefabric.WaitingForNodes),
                    string(servicefabric.Deploying),
                    string(servicefabric.BaselineUpgrade),
                    string(servicefabric.UpdatingUserConfiguration),
                    string(servicefabric.UpdatingUserCertificate),
                    string(servicefabric.UpdatingInfrastructure),
                    string(servicefabric.EnforcingClusterVersion),
                    string(servicefabric.UpgradeServiceUnreachable),
                    string(servicefabric.AutoScale),
                    string(servicefabric.Ready),
                }, false),
                Default: string(servicefabric.WaitingForNodes),
            },
            ...
            "reliability_level": {
                ...
                Optional: true,
                ValidateFunc: validation.StringInSlice([]string{
                    string(servicefabric.None),
                    string(servicefabric.Bronze),
                    string(servicefabric.Silver),
                    string(servicefabric.Gold),
                    string(servicefabric.Platinum),
                }, false),
                Default: string(servicefabric.None),
            },
...
func resourceArmClusterCreate(d *schema.ResourceData, meta interface{}) error {
    ...
    addOnFeatures := d.Get("add_on_features").([]interface{})
    availableClusterVersions := d.Get("available_cluster_versions").([]interface{})
    ...
    clusterState := d.Get("cluster_state").(string)
    ...
    parameters := servicefabric.Cluster{
        ...
        ClusterProperties: &servicefabric.ClusterProperties{
            AddOnFeatures: expandArmCluster(addOnFeatures),
            AvailableClusterVersions: expandArmClusterClusterVersionDetails(availableClusterVersions),
            ...
            ClusterState: servicefabric.(clusterState),
...
func resourceArmClusterRead(d *schema.ResourceData, meta interface{}) error {
    ...
    if clusterProperties := resp.ClusterProperties; clusterProperties != nil {
        if err := d.Set("add_on_features", flattenArmCluster(string(clusterProperties.AddOnFeatures))); err != nil {
...
func expandArmCluster(input []interface{}) *[]servicefabric. {
    results := make([]servicefabric., 0)
    for _, item := range input {
        v := item.(string)
        result := servicefabric.(v)
        results = append(results, result)
    }
    return &results
}

func expandArmClusterClusterVersionDetails(input []interface{}) *[]servicefabric.ClusterVersionDetails {
    results := make([]servicefabric.ClusterVersionDetails, 0)
    for _, item := range input {
        v := item.(map[string]interface{})
        codeVersion := v["code_version"].(string)
        supportExpiryUtc := v["support_expiry_utc"].(string)
        environment := v["environment"].(string)

        result := servicefabric.ClusterVersionDetails{
            CodeVersion: utils.String(codeVersion),
            Environment: servicefabric.(environment),
            SupportExpiryUtc: utils.String(supportExpiryUtc),
        }
...
func flattenArmCluster(input *[]servicefabric.) []interface{} {
