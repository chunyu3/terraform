...
func resourceArmSpatialAnchorsAccountCreate(d *schema.ResourceData, meta interface{}) error {
    ...
    if features.ShouldResourcesBeImported() && d.IsNewResource() {
        ...
        if err != nil {
            if !utils.ResponseWasNotFound(existing.Response) {
                return fmt.Errorf("Error checking for present of existing Spatial Anchors Account (Account Name %q / Resource Group %q): %+v", name, resourceGroupName, err)
            }
        }
    ...
    if _, err := client.Create(ctx, resourceGroupName, name, spatialAnchorsAccount); err != nil {
        return fmt.Errorf("Error creating Spatial Anchors Account (Account Name %q / Resource Group %q): %+v", name, resourceGroupName, err)
    }


    resp, err := client.Get(ctx, resourceGroupName, name)
    if err != nil {
        return fmt.Errorf("Error retrieving Spatial Anchors Account (Account Name %q / Resource Group %q): %+v", name, resourceGroupName, err)
    }
    if resp.ID == nil {
        return fmt.Errorf("Cannot read Spatial Anchors Account (Account Name %q / Resource Group %q) ID", name, resourceGroupName)
    }
    d.SetId(*resp.ID)
...
func resourceArmSpatialAnchorsAccountRead(d *schema.ResourceData, meta interface{}) error {
    ...
    if err != nil {
        ...
        return fmt.Errorf("Error reading Spatial Anchors Account (Account Name %q / Resource Group %q): %+v", name, resourceGroupName, err)
    }
...
func resourceArmSpatialAnchorsAccountUpdate(d *schema.ResourceData, meta interface{}) error {
    ...
    if _, err := client.Update(ctx, resourceGroupName, name, spatialAnchorsAccount); err != nil {
        return fmt.Errorf("Error updating Spatial Anchors Account (Account Name %q / Resource Group %q): %+v", name, resourceGroupName, err)
    }
...
func resourceArmSpatialAnchorsAccountDelete(d *schema.ResourceData, meta interface{}) error {
    ...
    if _, err := client.Delete(ctx, resourceGroupName, name); err != nil {
        return fmt.Errorf("Error deleting Spatial Anchors Account (Account Name %q / Resource Group %q): %+v", name, resourceGroupName, err)
    }
