...
func testCheckAzureRMSpatialAnchorsAccountExists(resourceName string) resource.TestCheckFunc {
    return func(s *terraform.State) error {
        ...
        if resp, err := client.Get(ctx, resourceGroup, accountName); err != nil {
            if utils.ResponseWasNotFound(resp.Response) {
                return fmt.Errorf("Bad: Spatial Anchors Account (Account Name %q / Resource Group %q) does not exist", accountName, resourceGroup)
            }
