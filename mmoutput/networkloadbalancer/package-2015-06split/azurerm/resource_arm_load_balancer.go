    ...
    for _, item := range input {
        ...
        result := network.BackendAddressPool{
            ...
            BackendAddressPoolPropertiesFormat: &network.BackendAddressPoolPropertiesFormat{
                BackendIpconfigurations: expandArmLoadBalancerInterfaceIPConfiguration(backendIpconfigurations),
    ...
    for _, item := range input {
        ...
        result := network.InboundNatRule{
            ...
            InboundNatRulePropertiesFormat: &network.InboundNatRulePropertiesFormat{
                BackendIpconfiguration: expandArmLoadBalancerInterfaceIPConfiguration(backendIpconfiguration),
                BackendPort: utils.Int32(int32(backendPort)),
...
func expandArmLoadBalancerInterfaceIPConfiguration(input []interface{}) *[]network.InterfaceIPConfiguration {
...
func flattenArmLoadBalancerBackendAddressPool(input *[]network.BackendAddressPool) []interface{} {
    ...
    for _, item := range *input {
        ...
        if backendAddressPoolPropertiesFormat := item.BackendAddressPoolPropertiesFormat; backendAddressPoolPropertiesFormat != nil {
            v["backend_ipconfigurations"] = flattenArmLoadBalancerInterfaceIPConfiguration(backendAddressPoolPropertiesFormat.BackendIpconfigurations)
...
func flattenArmLoadBalancerInboundNatRule(input *[]network.InboundNatRule) []interface{} {
    ...
    for _, item := range *input {
        ...
        if inboundNatRulePropertiesFormat := item.InboundNatRulePropertiesFormat; inboundNatRulePropertiesFormat != nil {
            v["backend_ipconfiguration"] = flattenArmLoadBalancerInterfaceIPConfiguration(inboundNatRulePropertiesFormat.BackendIpconfiguration)
...
func flattenArmLoadBalancerInterfaceIPConfiguration(input *[]network.InterfaceIPConfiguration) []interface{} {
    results := make([]interface{}, 0)
    if input == nil {
        return results
    }
