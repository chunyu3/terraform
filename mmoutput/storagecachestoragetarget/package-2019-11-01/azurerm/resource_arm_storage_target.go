...
func resourceArmStorageTarget() *schema.Resource {
    return &schema.Resource{
        Create: resourceArmStorageTargetCreateUpdate,
        Read: resourceArmStorageTargetRead,
        Update: resourceArmStorageTargetCreateUpdate,
...
func resourceArmStorageTargetCreateUpdate(d *schema.ResourceData, meta interface{}) error {
