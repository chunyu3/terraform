...
func resourceArmStorageTargetCreate(d *schema.ResourceData, meta interface{}) error {
    ...
    future, err := client.Create(ctx, resourceGroup, cacheName, storageTargetName, storagetarget)
    if err != nil {
...
func resourceArmStorageTargetUpdate(d *schema.ResourceData, meta interface{}) error {
    ...
    if _, err := client.Update(ctx, resourceGroup, cacheName, storageTargetName, storagetarget); err != nil {
        return fmt.Errorf("Error updating Storage Target (Storage Target Name %q / Cache Name %q / Resource Group %q): %+v", storageTargetName, cacheName, resourceGroup, err)
    }
