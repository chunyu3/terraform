        ...
        Schema: map[string]*schema.Schema{
            ...
            "status": {
                ...
                ValidateFunc: validation.StringInSlice([]string{
                    ...
                    string(servicebus.Created),
                    string(servicebus.Activating),
                    string(servicebus.Enabling),
                    string(servicebus.Active),
                    string(servicebus.Disabling),
                    string(servicebus.Disabled),
                    string(servicebus.SoftDeleting),
                    string(servicebus.SoftDeleted),
                    string(servicebus.Removing),
                    string(servicebus.Removed),
                    string(servicebus.Failed),
                }, false),
                Default: string(servicebus.Unknown),
            },
...
func resourceArmNamespaceCreate(d *schema.ResourceData, meta interface{}) error {
    ...
    createAcsnamespace := d.Get("create_acsnamespace").(bool)
    ...
    parameters := servicebus.NamespaceCreateOrUpdateParameters{
        ...
        NamespaceProperties: &servicebus.NamespaceProperties{
            CreateAcsnamespace: utils.Bool(createAcsnamespace),
            Enabled: utils.Bool(enabled),
            Status: servicebus.NamespaceState(status),
        },
...
func resourceArmNamespaceRead(d *schema.ResourceData, meta interface{}) error {
    ...
    if namespaceProperties := resp.NamespaceProperties; namespaceProperties != nil {
        d.Set("create_acsnamespace", namespaceProperties.CreateAcsnamespace)
...
func expandArmNamespaceSku(input []interface{}) *servicebus.Sku {
    if len(input) == 0 {
        return nil
    }
...
func flattenArmNamespaceSku(input *servicebus.Sku) []interface{} {
    if input == nil {
