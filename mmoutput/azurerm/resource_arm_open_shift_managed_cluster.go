                    ...
                    Schema: map[string]*schema.Schema{
                        ...
                        "vm_size": {
                            ...
                            ValidateFunc: validation.StringInSlice([]string{
                                string(containerservice.Standard_D2s_v3),
                                string(containerservice.Standard_D4s_v3),
                                string(containerservice.Standard_D8s_v3),
                                string(containerservice.Standard_D16s_v3),
                                string(containerservice.Standard_D32s_v3),
                                string(containerservice.Standard_D64s_v3),
                                string(containerservice.Standard_DS4_v2),
                                string(containerservice.Standard_DS5_v2),
                                string(containerservice.Standard_F8s_v2),
                                string(containerservice.Standard_F16s_v2),
                                string(containerservice.Standard_F32s_v2),
                                string(containerservice.Standard_F64s_v2),
                                string(containerservice.Standard_F72s_v2),
                                string(containerservice.Standard_F8s),
                                string(containerservice.Standard_F16s),
                                string(containerservice.Standard_E4s_v3),
                                string(containerservice.Standard_E8s_v3),
                                string(containerservice.Standard_E16s_v3),
                                string(containerservice.Standard_E20s_v3),
                                string(containerservice.Standard_E32s_v3),
                                string(containerservice.Standard_E64s_v3),
                                string(containerservice.Standard_GS2),
                                string(containerservice.Standard_GS3),
                                string(containerservice.Standard_GS4),
                                string(containerservice.Standard_GS5),
                                string(containerservice.Standard_DS12_v2),
                                string(containerservice.Standard_DS13_v2),
                                string(containerservice.Standard_DS14_v2),
                                string(containerservice.Standard_DS15_v2),
                                string(containerservice.Standard_L4s),
                                string(containerservice.Standard_L8s),
                                string(containerservice.Standard_L16s),
                                string(containerservice.Standard_L32s),
                            }, false),
                        },
                        "os_type": {
                            Type: schema.TypeString,
                        ...
                        "role": {
                            ...
                            Default: string(containerservice.compute),
                        },
                        "subnet_cidr": {
                            Type: schema.TypeString,
                            Optional: true,
...
func resourceArmOpenShiftManagedClusterCreateUpdate(d *schema.ResourceData, meta interface{}) error {
    ...
    if features.ShouldResourcesBeImported() && d.IsNewResource() {
        ...
        if !utils.ResponseWasNotFound(resp.Response) {
            return tf.ImportAsExistsError("azurerm_open_shift_managed_cluster", *resp.ID)
        }
    }
...
func expandArmOpenShiftManagedClusterPurchasePlan(input []interface{}) *containerservice.PurchasePlan {
    if len(input) == 0 {
        return nil
    }
    ...
    result := containerservice.PurchasePlan{
...
func expandArmOpenShiftManagedClusterOpenShiftManagedClusterAgentPoolProfile(input []interface{}) *[]containerservice.OpenShiftManagedClusterAgentPoolProfile {
    results := make([]containerservice.OpenShiftManagedClusterAgentPoolProfile, 0)
    for _, item := range input {
        ...
        result := containerservice.OpenShiftManagedClusterAgentPoolProfile{
...
func expandArmOpenShiftManagedClusterOpenShiftManagedClusterAuthProfile(input []interface{}) *containerservice.OpenShiftManagedClusterAuthProfile {
    if len(input) == 0 {
        return nil
    }
    v := input[0].(map[string]interface{})
    ...
    result := containerservice.OpenShiftManagedClusterAuthProfile{
        IdentityProviders: expandArmOpenShiftManagedClusterOpenShiftManagedClusterIdentityProvider(identityProviders),
    }
    return &result
}

func expandArmOpenShiftManagedClusterOpenShiftManagedClusterMasterPoolProfile(input []interface{}) *containerservice.OpenShiftManagedClusterMasterPoolProfile {
    if len(input) == 0 {
        return nil
    }
    v := input[0].(map[string]interface{})
    ...
    result := containerservice.OpenShiftManagedClusterMasterPoolProfile{
        Count: utils.Int32(int32(count)),
        Name: utils.String(name),
        OsType: containerservice.OSType(osType),
        SubnetCidr: utils.String(subnetCidr),
...
func expandArmOpenShiftManagedClusterNetworkProfile(input []interface{}) *containerservice.NetworkProfile {
    if len(input) == 0 {
        return nil
    }
    v := input[0].(map[string]interface{})
    ...
    result := containerservice.NetworkProfile{
...
func expandArmOpenShiftManagedClusterOpenShiftRouterProfile(input []interface{}) *[]containerservice.OpenShiftRouterProfile {
    results := make([]containerservice.OpenShiftRouterProfile, 0)
    for _, item := range input {
        v := item.(map[string]interface{})
        name := v["name"].(string)

        result := containerservice.OpenShiftRouterProfile{
            Name: utils.String(name),
        }
...
func expandArmOpenShiftManagedClusterOpenShiftManagedClusterIdentityProvider(input []interface{}) *[]containerservice.OpenShiftManagedClusterIdentityProvider {
    results := make([]containerservice.OpenShiftManagedClusterIdentityProvider, 0)
    for _, item := range input {
        v := item.(map[string]interface{})
        name := v["name"].(string)

        result := containerservice.OpenShiftManagedClusterIdentityProvider{
            Name: utils.String(name),
        }
...
func flattenArmOpenShiftManagedClusterOpenShiftManagedClusterAgentPoolProfile(input *[]containerservice.OpenShiftManagedClusterAgentPoolProfile) []interface{} {
...
func flattenArmOpenShiftManagedClusterOpenShiftManagedClusterAuthProfile(input *containerservice.OpenShiftManagedClusterAuthProfile) []interface{} {
    if input == nil {
...
func flattenArmOpenShiftManagedClusterOpenShiftManagedClusterMasterPoolProfile(input *containerservice.OpenShiftManagedClusterMasterPoolProfile) []interface{} {
    if input == nil {
        return make([]interface{}, 0)
    }
...
func flattenArmOpenShiftManagedClusterNetworkProfile(input *containerservice.NetworkProfile) []interface{} {
    if input == nil {
        return make([]interface{}, 0)
    }
...
func flattenArmOpenShiftManagedClusterOpenShiftRouterProfile(input *[]containerservice.OpenShiftRouterProfile) []interface{} {
    results := make([]interface{}, 0)
    if input == nil {
        return results
    }
...
func flattenArmOpenShiftManagedClusterPurchasePlan(input *containerservice.PurchasePlan) []interface{} {
    if input == nil {
        return make([]interface{}, 0)
    }
...
func flattenArmOpenShiftManagedClusterOpenShiftManagedClusterIdentityProvider(input *[]containerservice.OpenShiftManagedClusterIdentityProvider) []interface{} {
    results := make([]interface{}, 0)
    if input == nil {
        return results
    }
