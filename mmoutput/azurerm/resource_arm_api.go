        ...
        Schema: map[string]*schema.Schema{
            ...
            "format": {
                ...
                ValidateFunc: validation.StringInSlice([]string{
                    ...
                    string(apimanagement.openapi+json),
                    string(apimanagement.openapi-link),
                }, false),
...
func resourceArmApiCreate(d *schema.ResourceData, meta interface{}) error {
    ...
    if features.ShouldResourcesBeImported() && d.IsNewResource() {
        ...
        if !utils.ResponseWasNotFound(resp.Response) {
            return tf.ImportAsExistsError("azurerm_api", *resp.ID)
        }
    }
    ...
    parameters := apimanagement.ApiCreateOrUpdateParameter{
        ApiCreateOrUpdateProperties: &apimanagement.ApiCreateOrUpdateProperties{
            ...
            Format: apimanagement.ContentFormat(format),
            IsCurrent: utils.Bool(isCurrent),
            Path: utils.String(path),
            Protocols: expandArmApi(protocols),
            ServiceURL: utils.String(serviceUrl),
            SourceApiID: utils.String(sourceApiId),
    ...
    future, err := client.CreateOrUpdate(ctx, resourceGroup, serviceName, apiID, parameters)
    if err != nil {
    ...
    if err = future.WaitForCompletionRef(ctx, client.Client); err != nil {
        return fmt.Errorf("Error waiting for creation of Api (Api %q / Service Name %q / Resource Group %q): %+v", apiID, serviceName, resourceGroup, err)
    }
...
func resourceArmApiRead(d *schema.ResourceData, meta interface{}) error {
    ...
    if apiCreateOrUpdateProperties := resp.ApiCreateOrUpdateProperties; apiCreateOrUpdateProperties != nil {
        ...
        d.Set("source_api_id", apiCreateOrUpdateProperties.SourceApiID)
        ...
        d.Set("subscription_required", apiCreateOrUpdateProperties.SubscriptionRequired)
