    ...
    parameters := batch.AccountCreateParameters{
        ...
        AccountCreateProperties: &batch.AccountCreateProperties{
            AutoStorage: &batch.AutoStorageBaseProperties{
                autoStorageAccountId: utils.String(autoStorageAccountId),
            },
...
func resourceArmBatchAccountRead(d *schema.ResourceData, meta interface{}) error {
    ...
    if accountCreateProperties := resp.AccountCreateProperties; accountCreateProperties != nil {
        ...
        if autoStorage := accountCreateProperties.AutoStorage; autoStorage != nil {
            d.Set("auto_storage_account_id", autoStorage.autoStorageAccountId)
            d.Set("auto_storage_account_id", (autoStorage.autoStorageAccountId).String())
        }
