...
func resourceArmAppServicePlanCreate(d *schema.ResourceData, meta interface{}) error {
    ...
    freeOfferExpirationTime := d.Get("free_offer_expiration_time").(string)
    ...
    maximumElasticWorkerCount := d.Get("maximum_elastic_worker_count").(int)
    ...
    appServicePlan := web.AppServicePlan{
        ...
        AppServicePlan_properties: &web.AppServicePlan_properties{
            FreeOfferExpirationTime: convertStringToDate(freeOfferExpirationTime),
            ...
            MaximumElasticWorkerCount: utils.Int32(int32(maximumElasticWorkerCount)),
...
func resourceArmAppServicePlanRead(d *schema.ResourceData, meta interface{}) error {
    ...
    if appServicePlanProperties := resp.AppServicePlan_properties; appServicePlanProperties != nil {
        d.Set("free_offer_expiration_time", (appServicePlanProperties.FreeOfferExpirationTime).String())
        ...
        d.Set("hyper_v", appServicePlanProperties.HyperV)
        d.Set("is_spot", appServicePlanProperties.IsSpot)
        d.Set("is_xenon", appServicePlanProperties.IsXenon)
        d.Set("maximum_elastic_worker_count", int(*appServicePlanProperties.MaximumElasticWorkerCount))
