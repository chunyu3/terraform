                ...
                Elem: &schema.Resource{
                    Schema: map[string]*schema.Schema{
                        ...
                        "vm_size": {
                            ...
                            Default: string(compute.Standard_A0),
                        },
                    },
                },
            },
                ...
                Elem: &schema.Resource{
                    Schema: map[string]*schema.Schema{
                        "orchestrator_type": {
                            ...
                            Optional: true,
                            ValidateFunc: validation.StringInSlice([]string{
                                string(compute.Mesos),
                                string(compute.SwarmPreview),
                                string(compute.DCOS),
                            }, false),
                            Default: string(compute.Mesos),
                        },
                    },
                },
            },
...
func resourceArmContainerServiceCreateUpdate(d *schema.ResourceData, meta interface{}) error {
    client := meta.(*ArmClient).containerServiceClient
