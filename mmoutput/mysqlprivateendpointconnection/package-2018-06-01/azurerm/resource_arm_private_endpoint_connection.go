...
func expandArmPrivateEndpointConnectionPrivateEndpointProperty(input []interface{}) *mysql.PrivateEndpointProperty {
    if len(input) == 0 {
        return nil
    }
    ...
    result := mysql.PrivateEndpointProperty{
        ID: utils.String(iD),
    }
    return &result
}

func expandArmPrivateEndpointConnectionPrivateLinkServiceConnectionStateProperty(input []interface{}) *mysql.PrivateLinkServiceConnectionStateProperty {
    if len(input) == 0 {
        return nil
    }
    v := input[0].(map[string]interface{})
    ...
    result := mysql.PrivateLinkServiceConnectionStateProperty{
...
func flattenArmPrivateEndpointConnectionPrivateEndpointProperty(input *mysql.PrivateEndpointProperty) []interface{} {
    if input == nil {
...
func flattenArmPrivateEndpointConnectionPrivateLinkServiceConnectionStateProperty(input *mysql.PrivateLinkServiceConnectionStateProperty) []interface{} {
    if input == nil {
        return make([]interface{}, 0)
    }
