                ...
                Elem: &schema.Resource{
                    Schema: map[string]*schema.Schema{
                        "type": {
                            ...
                            Default: string(web.SystemAssigned),
                        },
                    },
                },
            },
...
func resourceArmWebAppCreate(d *schema.ResourceData, meta interface{}) error {
    ...
    snapshotInfo := d.Get("snapshot_info").([]interface{})
    ...
    siteEnvelope := web.Site{
        ...
        Site_properties: &web.Site_properties{
            ...
            SnapshotInfo: expandArmWebAppSnapshotRecoveryRequest(snapshotInfo),
        },
        Tags: tags.Expand(t),
    }
...
func resourceArmWebAppRead(d *schema.ResourceData, meta interface{}) error {
    ...
    if siteProperties := resp.Site_properties; siteProperties != nil {
        ...
        if err := d.Set("snapshot_info", flattenArmWebAppSnapshotRecoveryRequest(siteProperties.SnapshotInfo)); err != nil {
            return fmt.Errorf("Error setting `snapshot_info`: %+v", err)
        }
...
func expandArmWebAppCloningInfo(input []interface{}) *web.CloningInfo {
    ...
    ignoreQuotas := v["ignore_quotas"].(bool)
    ...
    result := web.CloningInfo{
        ...
        IgnoreQuotas: utils.Bool(ignoreQuotas),
...
func expandArmWebAppSnapshotRecoveryRequest(input []interface{}) *web.SnapshotRecoveryRequest {
    if len(input) == 0 {
        return nil
    }
    v := input[0].(map[string]interface{})
    ...
    kind := v["kind"].(string)
    snapshotTime := v["snapshot_time"].(string)
    recoveryTarget := v["recovery_target"].([]interface{})
    overwrite := v["overwrite"].(bool)
    recoverConfiguration := v["recover_configuration"].(bool)
    ignoreConflictingHostNames := v["ignore_conflicting_host_names"].(bool)

    result := web.SnapshotRecoveryRequest{
        Kind: utils.String(kind),
        SnapshotRecoveryRequest_properties: &web.SnapshotRecoveryRequest_properties{
            IgnoreConflictingHostNames: utils.Bool(ignoreConflictingHostNames),
            Overwrite: utils.Bool(overwrite),
            RecoverConfiguration: utils.Bool(recoverConfiguration),
            RecoveryTarget: expandArmWebAppSnapshotRecoveryTarget(recoveryTarget),
            SnapshotTime: utils.String(snapshotTime),
        },
    }
    return &result
}
...
func expandArmWebAppSnapshotRecoveryTarget(input []interface{}) *web.SnapshotRecoveryTarget {
    if len(input) == 0 {
        return nil
    }
    v := input[0].(map[string]interface{})
    ...
    result := web.SnapshotRecoveryTarget{
        ID: utils.String(id),
        Location: utils.String(location),
    }
    return &result
...
func flattenArmWebAppCloningInfo(input *web.CloningInfo) []interface{} {
    ...
    if ignoreQuotas := input.IgnoreQuotas; ignoreQuotas != nil {
        result["ignore_quotas"] = *ignoreQuotas
    }
...
func flattenArmWebAppSnapshotRecoveryRequest(input *web.SnapshotRecoveryRequest) []interface{} {
    if input == nil {
        return make([]interface{}, 0)
    }
    ...
    if snapshotRecoveryRequestProperties := input.SnapshotRecoveryRequest_properties; snapshotRecoveryRequestProperties != nil {
        if ignoreConflictingHostNames := snapshotRecoveryRequestProperties.IgnoreConflictingHostNames; ignoreConflictingHostNames != nil {
            result["ignore_conflicting_host_names"] = *ignoreConflictingHostNames
        }
        if overwrite := snapshotRecoveryRequestProperties.Overwrite; overwrite != nil {
            result["overwrite"] = *overwrite
        }
        if recoverConfiguration := snapshotRecoveryRequestProperties.RecoverConfiguration; recoverConfiguration != nil {
            result["recover_configuration"] = *recoverConfiguration
        }
        result["recovery_target"] = flattenArmWebAppSnapshotRecoveryTarget(snapshotRecoveryRequestProperties.RecoveryTarget)
        if snapshotTime := snapshotRecoveryRequestProperties.SnapshotTime; snapshotTime != nil {
            result["snapshot_time"] = *snapshotTime
        }
    }
...
func flattenArmWebAppSnapshotRecoveryTarget(input *web.SnapshotRecoveryTarget) []interface{} {
    if input == nil {
        return make([]interface{}, 0)
    }
