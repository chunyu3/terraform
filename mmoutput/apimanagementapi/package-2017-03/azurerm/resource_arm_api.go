...
func resourceArmApiCreate(d *schema.ResourceData, meta interface{}) error {
    ...
    parameters := apimanagement.ApiCreateOrUpdateParameter{
        ApiCreateOrUpdateProperties: &apimanagement.ApiCreateOrUpdateProperties{
            ...
            ApiVersionSet: expandArmApiApiVersionSetContract(apiVersionSet),
...
func resourceArmApiRead(d *schema.ResourceData, meta interface{}) error {
    ...
    if apiCreateOrUpdateProperties := resp.ApiCreateOrUpdateProperties; apiCreateOrUpdateProperties != nil {
        ...
        if err := d.Set("api_version_set", flattenArmApiApiVersionSetContract(apiCreateOrUpdateProperties.ApiVersionSet)); err != nil {
...
func expandArmApiApiVersionSetContract(input []interface{}) *apimanagement.ApiVersionSetContract {
    if len(input) == 0 {
        return nil
    }
    ...
    result := apimanagement.ApiVersionSetContract{
...
func flattenArmApiApiVersionSetContract(input *apimanagement.ApiVersionSetContract) []interface{} {
    if input == nil {
    ...
    if apiVersionSetContractProperties := input.ApiVersionSetContractProperties; apiVersionSetContractProperties != nil {
        if description := apiVersionSetContractProperties.Description; description != nil {
            result["description"] = *description
        }
        if displayName := apiVersionSetContractProperties.DisplayName; displayName != nil {
            result["display_name"] = *displayName
        }
        if versionHeaderName := apiVersionSetContractProperties.VersionHeaderName; versionHeaderName != nil {
            result["version_header_name"] = *versionHeaderName
        }
        if versionQueryName := apiVersionSetContractProperties.VersionQueryName; versionQueryName != nil {
            result["version_query_name"] = *versionQueryName
        }
        result["versioning_scheme"] = string(apiVersionSetContractProperties.VersioningScheme)
    }
