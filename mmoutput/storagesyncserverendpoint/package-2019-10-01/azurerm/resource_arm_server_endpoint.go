...
func flattenArmServerEndpointServerEndpointCloudTieringStatus(input *storagesync.ServerEndpointCloudTieringStatus) []interface{} {
    ...
    result["cache_performance"] = flattenArmServerEndpointCloudTieringCachePerformance(input.CachePerformance)
    result["date_policy_status"] = flattenArmServerEndpointCloudTieringDatePolicyStatus(input.DatePolicyStatus)
    result["files_not_tiering"] = flattenArmServerEndpointCloudTieringFilesNotTiering(input.FilesNotTiering)
    result["health"] = string(input.Health)
    if healthLastUpdatedTimestamp := input.HealthLastUpdatedTimestamp; healthLastUpdatedTimestamp != nil {
        result["health_last_updated_timestamp"] = (*healthLastUpdatedTimestamp).String()
    }
    ...
    result["space_savings"] = flattenArmServerEndpointCloudTieringSpaceSavings(input.SpaceSavings)
    result["volume_free_space_policy_status"] = flattenArmServerEndpointCloudTieringVolumeFreeSpacePolicyStatus(input.VolumeFreeSpacePolicyStatus)
...
func flattenArmServerEndpointCloudTieringCachePerformance(input *storagesync.CloudTieringCachePerformance) []interface{} {
    if input == nil {
        return make([]interface{}, 0)
    }
    ...
    if cacheHitBytes := input.CacheHitBytes; cacheHitBytes != nil {
        result["cache_hit_bytes"] = int(*cacheHitBytes)
    }
    if cacheHitBytesPercent := input.CacheHitBytesPercent; cacheHitBytesPercent != nil {
        result["cache_hit_bytes_percent"] = int(*cacheHitBytesPercent)
    }
    if cacheMissBytes := input.CacheMissBytes; cacheMissBytes != nil {
        result["cache_miss_bytes"] = int(*cacheMissBytes)
    }
    if lastUpdatedTimestamp := input.LastUpdatedTimestamp; lastUpdatedTimestamp != nil {
        result["last_updated_timestamp"] = (*lastUpdatedTimestamp).String()
    }
...
func flattenArmServerEndpointCloudTieringDatePolicyStatus(input *storagesync.CloudTieringDatePolicyStatus) []interface{} {
    if input == nil {
        return make([]interface{}, 0)
    }
    ...
    if tieredFilesMostRecentAccessTimestamp := input.TieredFilesMostRecentAccessTimestamp; tieredFilesMostRecentAccessTimestamp != nil {
        result["tiered_files_most_recent_access_timestamp"] = (*tieredFilesMostRecentAccessTimestamp).String()
    }

    return []interface{}{result}
}

func flattenArmServerEndpointCloudTieringFilesNotTiering(input *storagesync.CloudTieringFilesNotTiering) []interface{} {
    if input == nil {
        return make([]interface{}, 0)
    }
    ...
    result["errors"] = flattenArmServerEndpointFilesNotTieringError(input.Errors)
    if lastUpdatedTimestamp := input.LastUpdatedTimestamp; lastUpdatedTimestamp != nil {
        result["last_updated_timestamp"] = (*lastUpdatedTimestamp).String()
    }
    if totalFileCount := input.TotalFileCount; totalFileCount != nil {
        result["total_file_count"] = int(*totalFileCount)
    }

    return []interface{}{result}
}

func flattenArmServerEndpointCloudTieringSpaceSavings(input *storagesync.CloudTieringSpaceSavings) []interface{} {
    if input == nil {
        return make([]interface{}, 0)
    }
    ...
    if cachedSizeBytes := input.CachedSizeBytes; cachedSizeBytes != nil {
        result["cached_size_bytes"] = int(*cachedSizeBytes)
    }
    if lastUpdatedTimestamp := input.LastUpdatedTimestamp; lastUpdatedTimestamp != nil {
        result["last_updated_timestamp"] = (*lastUpdatedTimestamp).String()
    }
    if spaceSavingsBytes := input.SpaceSavingsBytes; spaceSavingsBytes != nil {
        result["space_savings_bytes"] = int(*spaceSavingsBytes)
    }
    if spaceSavingsPercent := input.SpaceSavingsPercent; spaceSavingsPercent != nil {
        result["space_savings_percent"] = int(*spaceSavingsPercent)
    }
    if totalSizeCloudBytes := input.TotalSizeCloudBytes; totalSizeCloudBytes != nil {
        result["total_size_cloud_bytes"] = int(*totalSizeCloudBytes)
    }
    if volumeSizeBytes := input.VolumeSizeBytes; volumeSizeBytes != nil {
        result["volume_size_bytes"] = int(*volumeSizeBytes)
    }

    return []interface{}{result}
}

func flattenArmServerEndpointCloudTieringVolumeFreeSpacePolicyStatus(input *storagesync.CloudTieringVolumeFreeSpacePolicyStatus) []interface{} {
    if input == nil {
        return make([]interface{}, 0)
    }
    ...
    if currentVolumeFreeSpacePercent := input.CurrentVolumeFreeSpacePercent; currentVolumeFreeSpacePercent != nil {
        result["current_volume_free_space_percent"] = int(*currentVolumeFreeSpacePercent)
    }
    if effectiveVolumeFreeSpacePolicy := input.EffectiveVolumeFreeSpacePolicy; effectiveVolumeFreeSpacePolicy != nil {
        result["effective_volume_free_space_policy"] = int(*effectiveVolumeFreeSpacePolicy)
    }
    if lastUpdatedTimestamp := input.LastUpdatedTimestamp; lastUpdatedTimestamp != nil {
        result["last_updated_timestamp"] = (*lastUpdatedTimestamp).String()
    }
...
func flattenArmServerEndpointFilesNotTieringError(input *[]storagesync.FilesNotTieringError) []interface{} {
    results := make([]interface{}, 0)
    if input == nil {
        return results
    }
    ...
    for _, item := range *input {
        ...
        if fileCount := item.FileCount; fileCount != nil {
            v["file_count"] = int(*fileCount)
        }
