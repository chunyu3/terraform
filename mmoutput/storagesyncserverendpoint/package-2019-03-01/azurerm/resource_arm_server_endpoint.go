...
func flattenArmServerEndpointServerEndpointSyncStatus(input *storagesync.ServerEndpointSyncStatus) []interface{} {
    ...
    result["download_activity"] = flattenArmServerEndpointSyncActivityStatus(input.DownloadActivity)
    ...
    result["upload_activity"] = flattenArmServerEndpointSyncActivityStatus(input.UploadActivity)
...
func flattenArmServerEndpointSyncActivityStatus(input *storagesync.SyncActivityStatus) []interface{} {
    if input == nil {
        return make([]interface{}, 0)
    }
...
func flattenArmServerEndpointSyncSessionStatus(input *storagesync.SyncSessionStatus) []interface{} {
    ...
    result["files_not_syncing_errors"] = flattenArmServerEndpointFilesNotSyncingError(input.FilesNotSyncingErrors)
...
func flattenArmServerEndpointFilesNotSyncingError(input *[]storagesync.FilesNotSyncingError) []interface{} {
