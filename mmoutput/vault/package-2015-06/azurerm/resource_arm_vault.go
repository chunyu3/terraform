...
func resourceArmVault() *schema.Resource {
    return &schema.Resource{
        Create: resourceArmVaultCreateUpdate,
        Read: resourceArmVaultRead,
        Update: resourceArmVaultCreateUpdate,
...
func resourceArmVaultCreateUpdate(d *schema.ResourceData, meta interface{}) error {
    ...
    if _, err := client.CreateOrUpdate(ctx, resourceGroup, vaultName, parameters); err != nil {
